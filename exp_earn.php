...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="masthead">
        ...
        <nav>
          <ul class="nav nav-justified">
            ...
            <li class="nav-item"><a class="nav-link active" href="exp_earn.php">Erfahrungspunkte verdienen</a></li>
      ...
      <!-- Jumbotron -->
      <div class="jumbotron">
        <h1>Du willst Erfahrungspunkte verdienen?</h1>
        <p class="lead">Reiche einen Vorschlag ein und lass deine Freunde entscheiden wie viele EXP du dafür bekommst!</p>
