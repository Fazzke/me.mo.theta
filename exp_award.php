...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="masthead">
        ...
        <nav>
          <ul class="nav nav-justified">
            ...
            <li class="nav-item"><a class="nav-link active" href="exp_award.php">EXP verteilen</a></li>
      ...
      <!-- Jumbotron -->
      <div class="jumbotron">
        <h1>Jetzt bist du der Gamemaster!</h1>
        <p class="lead"> Jeder darf mitentscheiden, wie viele Punkte deine Freunde für ihre Vorschläge erhalten.</p>
