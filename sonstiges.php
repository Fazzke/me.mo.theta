...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="masthead">
        ...
        <nav>
          <ul class="nav nav-justified">
            ...
            <li class="nav-item"><a class="nav-link" href="profil.php">Dein Profil</a></li>
            ...
            <li class="nav-item"><a class="nav-link active" href="sonstiges.php">Sonstiges</a></li>
          </ul>
        </nav>
      </div>
      ...
      <!-- Jumbotron -->
      <div class="jumbotron">
        <h1>Sonstiger Spaß und Trollereien jaja...</h1>
        <p class="lead">Du bist für weiteren qulitativ hochwertigen Blödsinn zu haben? Dann hau noch heute nicht mehr ab! Schau dir an, was wir für SPAM für dich bereithalten:</p>
