...
<html lang="en">
  ...
  <body>
    ...
    <div class="container">
      ...
      <div class="masthead">
        ...
        <nav>
          <ul class="nav nav-justified">
            ...
            <li class="nav-item"><a class="nav-link active" href="exp_all.php">EXP von Allen!!</a></li>
      ...
      <!-- Jumbotron -->
      <div class="jumbotron">
        <h1>EXP von ALLEN! Ja genau, von ALLENFREUNDENWOGEHT!</h1>
        <p class="lead">Hier kannst du sehen wer am coolsten ist:</p>
